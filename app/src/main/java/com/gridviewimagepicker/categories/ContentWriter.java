...
public class ContentWriter extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("profession").equalTo("Content Writer");
    ...
    public void onResume(){
        super.onResume();
        ((MainActivity) getActivity()).setActionBarTitle("Content Writer");
    }
