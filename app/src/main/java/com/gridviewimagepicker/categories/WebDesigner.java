...
public class WebDesigner extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Query query = databaseReference.orderByChild("profession").equalTo("Web Designer");
    ...
    public void onResume(){
        super.onResume();
        ((MainActivity) getActivity()).setActionBarTitle("Web Designer");
    }
